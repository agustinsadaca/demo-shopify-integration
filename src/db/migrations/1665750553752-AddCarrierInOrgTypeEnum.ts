...
export class AddCarrierInOrgTypeEnum1665750553752 implements MigrationInterface {
    name = 'AddCarrierInOrgTypeEnum1665750553752'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."automation_rule_target_type_enum" AS ENUM('shop', 'wms', 'carrier')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."automation_rule_action_enum" AS ENUM('getMany', 'getManyConfirmed', 'getManyCancelled', 'getMovements', 'getErrors', 'create', 'updateMany', 'cancel', 'open', 'lowStockNotification', 'getTrackingDetails')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."carrier_auth_provided_by_enum" AS ENUM('shop', 'wms', 'carrier')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."sync_preference_target_enum" AS ENUM('shop', 'wms', 'carrier')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."connection_auth_target_type_enum" AS ENUM('shop', 'wms', 'carrier')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."connection_auth_target_type_enum_old" AS ENUM('shop', 'wms')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."sync_preference_target_enum_old" AS ENUM('shop', 'wms')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."carrier_auth_provided_by_enum_old" AS ENUM('shop', 'wms')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."automation_rule_action_enum_old" AS ENUM('getMany', 'getManyConfirmed', 'getManyCancelled', 'getMovements', 'getErrors', 'create', 'updateMany', 'cancel', 'open', 'lowStockNotification')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."automation_rule_entity_enum_old" AS ENUM('order', 'inventory-item', 'partner-location-inventory-item', 'order-item', 'outbound-shipment', 'outbound-shipment-item', 'return-shipment', 'return-shipment-item', 'inventory-level', 'inbound-notice', 'inbound-receipt', 'returnRequest', 'error')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."automation_rule_target_type_enum_old" AS ENUM('shop', 'wms')`);
